...
ajaxRequest
  ...
  .then(function (data) {
    ...
    if (data.naoautenticado) {
      ...
      document.getElementById("text_tipo_historico").innerHTML = data.tipo_historico;
      if(data.historico.length==0){
        document.getElementById("qtd_itens").innerHTML="<br>Nenhum histórico encontrado!";
      }else{
        document.getElementById("qtd_itens").innerHTML="<br>"+data.historico.length+" Itens";
      }
